...
public class VerifyThatOwnerNameIsMandatoryFiledTest extends TestBase {
    ...
    @Description("Verify That Owner Name Is Mandatory Filed")
    @Feature("Mandatory Filed")
    @Epic("Funding Request")
    public void VerifyThatOwnerNameIsMandatoryFiled() throws InterruptedException {
...
//        fundingRequestLunchObject.clickOnFundingRequest();
        ...
        createFundingRequestStepObject.enterInitiativeOwnerData("",
        ...
        validationMessageForFirstStepObject.verifyThatValidationMessageForOwnerNameDisplayed("اسم مالك المبادرة");
