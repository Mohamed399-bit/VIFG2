...
public class SearchForInitiativeByUICTest extends TestBase {
    ...
    @Description("Search For Initiative By UIC")
    ...
    public void SearchForInitiativeByName() throws InterruptedException {
        ...
        initiativeNameListObject.SelectInitiativeUIC(Helper.generateRandomNumber2(0, 4));
