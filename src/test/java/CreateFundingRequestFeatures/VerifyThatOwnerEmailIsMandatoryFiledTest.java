...
public class VerifyThatOwnerEmailIsMandatoryFiledTest extends TestBase {
    ...
    @Description("Verify That Owner Email Is Mandatory Filed")
    @Feature("Mandatory Filed")
    @Epic("Funding Request")
    public void VerifyThatOwnerEmailIsMandatoryFiled() throws InterruptedException {
...
//        fundingRequestLunchObject.clickOnFundingRequest();
        ...
        createFundingRequestStepObject.enterInitiativeOwnerData(Helper.generateRandomWords2(3),
                "" ,"56"+Helper.generateRandomNumber(7));
        ...
        validationMessageForFirstStepObject.verifyThatValidationMessageForOwnerEmailDisplayed("البريد الالكتروني");
