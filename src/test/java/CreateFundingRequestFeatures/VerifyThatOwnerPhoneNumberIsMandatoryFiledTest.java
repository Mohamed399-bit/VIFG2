...
public class VerifyThatOwnerPhoneNumberIsMandatoryFiledTest extends TestBase {
    ...
    @Description("Verify That Owner Phone Number Is Mandatory Filed")
    @Feature("Mandatory Filed")
    @Epic("Funding Request")
    public void VerifyThatOwnerPhoneNumberIsMandatoryFiled() throws InterruptedException {
...
//        fundingRequestLunchObject.clickOnFundingRequest();
        ...
        createFundingRequestStepObject.enterInitiativeOwnerData(Helper.generateRandomWords2(3),
                Helper.generateRandomName(7)+"@Test.com" ,"");
        ...
        validationMessageForFirstStepObject.verifyThatValidationMessageForOwnerPhoneDisplayed("رقم الجوال");
