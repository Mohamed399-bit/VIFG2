...
public class CompletedInitiativeDataWithNextDateTest extends TestBase {
    ...
    int Month = Helper.enterNextMonth();
    String Year = Helper.getTodayYear();
    String Day = Helper.createNextDate();
    ...
    @Description("Complete Data For Uncompleted Initiative with start date equal next date ")
